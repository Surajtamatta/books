...
const TermsConditions = () => {
  ...
  <div class="bg-white rounded-lg shadow-lg max-w-3xl w-full p-6 z-50">
    ...
    <div class="border-b pb-2 mb-4">
      <h2 class="text-lg font-bold text-[#bb87c9] uppercase tracking-widest">
        Terms & Conditions
      </h2>
    </div>
    ...
    <div class="space-y-4 text-gray-700">
      ...
      <h3 class="text-xl  text-[#bb87c9] font-semibold">Privacy Policy </h3>
      ...
      <h3 class="text-xl  text-[#bb87c9] font-semibold mt-6">Terms of Service</h3>
      <p className='font-montserrat text-base text-justify'>
    ...
    <div class="flex justify-end mt-6">
      <button
        class="bg-[#d394e2] w-28 hover:bg-[#c28bd0] text-white font-semibold py-2 px-4 rounded"
        onClick={closeModal}
      >
        OK
      </button>
